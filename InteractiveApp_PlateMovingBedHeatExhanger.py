...
eps_s = st.sidebar.slider("Solid Voidage ratio (ε_s)", min_value=0.2, max_value=0.8, value=0.4, step=0.01)
...
T_fin = st.sidebar.number_input("Fluid inlet temperature (°C)", value=22.0)
